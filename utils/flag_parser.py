...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default=True,
        metavar="JGM",
        help="wherether to use judge model",
    )
    ...
    parser.add_argument(
        "--load_model", type=str, default="", help="Path to load a saved RL model."
    )

    parser.add_argument(
        "--load_JG_model", type=str, default="", help="Path to load a saved Judge model."
    )
    ...
    parser.add_argument(
        "--max_ep", type=float, default=3000000, help="maximum # of episodes"
    )
