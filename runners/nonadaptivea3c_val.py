...
from models import JudgeModelCM
...
def nonadaptivea3c_val(
    ...
    if model_to_open != "":
        try:
            ...
            shared_model.load_state_dict(torch.load(model_to_open))
    ...
    if args.judge_model == True:
        ...
        player = initialize_agent(model_create_fn, args, rank, NB_model,NB_optimizer,NB_criterion,gpu_id=gpu_id)
