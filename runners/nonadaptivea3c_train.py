...
def nonadaptivea3c_train(
    ...
    if not NB_model == None:
        player = initialize_agent(create_shared_model, args, rank, NB_model,NB_optimizer,NB_criterion,gpu_id=gpu_id)
    else:
    ...
    while not end_flag.value:
        ...
        while not player.done:
            ...
            if compute_grad:
                ...
                print("Total_loss = {}, reward = {}".format(loss["total_loss"],total_reward))
